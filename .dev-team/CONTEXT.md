...
- 2026-09-24: Synced pinned upstream main 8f9cf53 (0.9.7 plus six commits). ASR initial prompt remains a Whisper-family inference setting, separate from LLM prompts; Capglue is removed from paste choices while legacy `capglue` settings migrate to CtrlV and exact built-in promptv3 entries are removed.
